        ...
        add_node:function(parent_node, nodeid, topic, data, idx, direction, expanded){
            ...
            if(parent_node.isroot){
                ...
                if(isNaN(direction)){
                    ...
                    d = (children_len > 1 && r > 0) ? jm.direction.right : jm.direction.right//一直靠右
                }else{
                    d = (direction != jm.direction.left) ? jm.direction.right : jm.direction.right;//一直靠右
                }
        ...
        set_node_color:function(nodeid, bgcolor, fgcolor){
            if(this.get_editable()){
                ...
                if(!!node){
                    ...
                    if(!bgcolor && !fgcolor){
                        node.data['background-color'] = null;
                        node.data['foreground-color'] = null;
                    }
                    this.view.reset_node_custom_style(node);
                }
            }else{
